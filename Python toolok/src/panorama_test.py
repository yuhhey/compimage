...
Wandafele_ejszaka_8bit = [ImageData(  -0.139998,     -2.473094,     -0.014117, "2011_06_23/Wandafele_ejszaka/8bit/IMG_0169.TIF"),
...
class RealDataTeszt(unittest.TestCase):
    ...
    def test_WandaPlaza(self, mock_y, mock_p):
        ...
        mock_y.side_effect = [ -0.139998,  -3.544796, -24.293692, 10.251049, 
                               17.210039,  13.729056, -31.117706,   6.780103,  31.073329, 24.144788, -3.542304,  24.143109,
                               10.256283, -24.289881,  10.252908, 27.614342,-10.491441, -20.865664,
                               -7.017981, -24.287542, -13.902046, 31.074217, 10.254946, -7.012104,
                              -20.862597,  13.729205,
                              -27.702427,
                              -27.699991,
                              3.297643,
